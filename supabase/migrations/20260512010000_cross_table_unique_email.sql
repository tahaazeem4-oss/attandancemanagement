-- Enforce unique email across all user tables (admins, super_admins, org_admins, teachers, parents, student_accounts)
...
BEGIN
  ...
  -- Check student portal accounts (students table does not store login email)
